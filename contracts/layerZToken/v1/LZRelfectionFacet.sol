...
contract LZReflectionFacet is BaseFacet {
    ...
    function acquireAccruedBNBLotteryTax() external ownerOnly {
    ...
    function excludeFromReward(address account) public ownerOnly {
    ...
    function includeInReward(address account) external ownerOnly {
        if (!_isExcluded[account]) {
