...
import {
	VRFConsumerBaseV2Test
} from "./lib/chainlink/VRFConsumerBaseV2Test.sol";
...
import {
	...
	LotteryEngineTest,
	LotteryRound
} from "./lib/LotteryEngineTest.sol";
...
contract LotteryTokenTest is LotteryEngineTest, ILotteryToken {
	...
	constructor (
		...
		VRFConsumerBaseV2Test(_coordinatorAddress)
		LotteryEngineTest(
			_routerAddress,
			_cConfig,
			_dConfig,
